...
from .od_rotated_single_stage_detector import KDAttAngle_RotatedSingleStageDetector
...
__all__ = [
    ...
    'RotatedSingleStageDetector', 'RotatedFCOS', 'KDAttAngle_RotatedSingleStageDetector'
]
